...
router.get(
  ...
  async function (req, res, next) {
    const result = await fetch(
      `http://census.daybreakgames.com/${process.env.API}/get/ps2:v2/faction?c:limit=10&c:lang=en`
    );
    if (result.ok) {
...
router.get(
  ...
  async function (req, res, next) {
    const result = await fetch(
      `http://census.daybreakgames.com/${process.env.API}/get/ps2:v2/profile?c:limit=500&c:lang=en&faction_id=1`
    );
    if (result.ok) {
      const resJson = await result.json();
      res.send(resJson);
...
router.get(
  ...
  async function (req, res, next) {
    const result = await fetch(
      `http://census.daybreakgames.com/${process.env.API}/get/ps2:v2/vehicle?c:limit=14&&c:lang=en`
    );
    if (result.ok) {
      const resJson = await result.json();
      res.send(resJson);
...
router.get(
  ...
  async function (req, res, next) {
    ...
    const result = await fetch(
      `http://census.daybreakgames.com/${process.env.API}/get/ps2:v2/leaderboard/?name=${type}&period=Forever&c:limit=10&c:resolve=character(name,times.minutes_played,faction)`
    );
    if (result.ok) {
      const resJson = await result.json();
      res.send(resJson);
...
router.get(
  ...
  async function (req, res, next) {
    ...
    const result = await fetch(
      `http://census.daybreakgames.com/${process.env.API}/get/ps2:v2/character/?character_id=${charid}&c:resolve=world,outfit,stat,stat_history,profile,online_status`
    );
    if (result.ok) {
      const resJson = await result.json();
      res.send(resJson);
...
router.get(
  ...
  async function (req, res, next) {
    ...
    try {
      ...
      const result = await fetch(
        `http://census.daybreakgames.com/${process.env.API}/get/ps2:v2/character_name/?name.first_lower=^${name}&c:limit=10&c:show=name.first&c:sort=name.first_lower`
      );
      if (result.ok) {
        const resJson = await result.json();
        res.send(resJson);
...
router.get(
  ...
  async function (req, res, next) {
    ...
    const result = await fetch(
      `http://census.daybreakgames.com/${process.env.API}/get/ps2:v2/outfit/?name=^${outfitname}&c:limit=10&c:sort=member_count:-1`
    );
    if (result.ok) {
      const resJson = await result.json();
      res.send(resJson);
