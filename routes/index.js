...
router.get('/factions', async function (req, res, next) {
...
router.get('/leaderboard/:id', async function (req, res, next) { //get leaderboard info
...
router.get('/charid/:id', async function (req, res, next) { //get specific character info
...
router.get('/char/:id', async function (req, res, next) { //get specific character info
...
router.get('/outfit/:id', async function (req, res, next) { //get specific outfit info
...
router.get('/chars/:id', async function (req, res, next) { //search by character name
  try {
...
router.get('/outfits/:id', async function (req, res, next) { //search by outfit name
